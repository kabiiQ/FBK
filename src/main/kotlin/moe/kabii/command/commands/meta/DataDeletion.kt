            ...
            .withEmbeds(
                Embeds.other(
                    StringBuilder()
                        ...
                        .appendLine()
                        .appendLine("This should only be used to delete your information for privacy reasons and is included as required by Discord.")
                        .appendLine("Usage of this command will DISABLE ALL BOT FUNCTIONALITY YOU ARE USING.")
                        .appendLine("Data from ALL VERSIONS of FBK will be affected.")
                        .appendLine()
                        .appendLine("Examples of configurations that will be irreversibly deleted and must be manually re-configured if desired:")
