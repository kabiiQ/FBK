        ...
        init {
            discord {
                validateAndAlterFilters(this) {
                    ...
                    if(args.size != 1) {
                        usage("**speed** is used to play a track on the music bot at a different speed. **speed 150** or **speed 1.5** will play the song at 150% speed, where **speed 100** or **speed 1** represents normal 100% speed.", "speed <% of original>")
                    ...
                    if(targetRate == null) {
                        reply(Embeds.error("Invalid playback rate **$arg**. Rate should be between 10% (.1/10) and 300% (3/300)")).awaitSingle()
                        return@validateAndAlterFilters
                    }
