    ...
    override fun run() {
        applicationLoop {
            ...
            try {
                ...
                // find any old youtube memberships
                val cutoff = DateTime.now().minusWeeks(3)
                // expire the old memberships in the database
                ...
                val configs = propagateTransaction {
                    MembershipConfiguration
                        .all()
                        .onEach { cfg -> cfg.load(MembershipConfiguration::discordServer) }
                }
                for(config in configs) {
                    ...
                    try {
                        ...
                        members
                            ...
                            .forEach { inactive ->
                                YoutubeMembershipUtil.roleAssignmentContext.launch {
